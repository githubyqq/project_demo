...
void showimage(const unsigned char *p) //显示40*40 QQ图片
{
	...
	LCD_Clear(WHITE); //清屏  
			...
			LCD_Address_Set(m*j,m*k,m*j+m-1,m*k+m-1);		//坐标设置
...
{
		LCD_ShowChinese(0,32,0,16,WHITE);  //温
		LCD_ShowChinese(16,32,1,16,WHITE);	//度
		LCD_ShowChinese(0,48,2,16,WHITE);		//湿
		LCD_ShowChinese(16,48,3,16,WHITE);	//度
		LCD_ShowChinese(32,32,4,16,WHITE);	//：
		LCD_ShowChinese(56,0,0,32,WHITE);		//监
		LCD_ShowChinese(88,0,1,32,WHITE);		//测
		LCD_ShowChinese(120,0,2,32,WHITE);	//系
		LCD_ShowChinese(152,0,3,32,WHITE);	//统
		LCD_ShowChinese(32,48,4,16,WHITE);	//：
		Draw_Circle(152,232,8,YELLOW);
		LCD_ShowChinese(160,224,5,16,WHITE);  //余
		LCD_ShowChinese(176,224,6,16,WHITE);	//清
		LCD_ShowChinese(192,224,7,16,WHITE);		//强
		LCD_ShowChinese(208,224,8,16,WHITE);	//出
		LCD_ShowChinese(224,224,9,16,WHITE);	//品
...
//	
		LCD_ShowChinese(0,64,12,16,WHITE);		//蜂
		LCD_ShowChinese(16,64,13,16,WHITE);		//敏
		LCD_ShowChinese(32,64,14,16,WHITE);		//器
		LCD_ShowChinese(48,64,15,16,WHITE);		//状
		LCD_ShowChinese(64,64,16,16,WHITE);	//态
		LCD_ShowChinese(80,64,4,16,WHITE);		//:
		
		LCD_ShowChar(0,80,'L',16,WHITE);		//蜂
		LCD_ShowChar(8,80,'E',16,WHITE);		//敏
		LCD_ShowChar(16,80,'D',16,WHITE);		//器
		LCD_ShowChinese(32,80,17,16,WHITE);		//状
		LCD_ShowChinese(48,80,15,16,WHITE);		//状
		LCD_ShowChinese(64,80,16,16,WHITE);	//态
		LCD_ShowChinese(80,80,4,16,WHITE);		//:
		
		LCD_ShowString(0,96,"X",WHITE);
		LCD_ShowChinese(16,96,11,16,WHITE);//轴
		LCD_ShowChinese(32,96,4,16,WHITE);		//:
		LCD_ShowString(0,112,"Y",WHITE);
		LCD_ShowChinese(16,112,11,16,WHITE);//轴
		LCD_ShowChinese(32,112,4,16,WHITE);		//:
		LCD_ShowString(0,128,"Z",WHITE);
		LCD_ShowChinese(16,128,11,16,WHITE);//轴
