...
#define LCD_SCLK_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_13)//SCK
#define LCD_SCLK_Set() GPIO_SetBits(GPIOB,GPIO_Pin_13)

#define LCD_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_14)//SDA
#define LCD_SDIN_Set() GPIO_SetBits(GPIOB,GPIO_Pin_14)
